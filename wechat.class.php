...
/**
            		$newmenu =  array(
						"button"=>array(
							array("name"=>'推荐阅读',
								  "sub_button"=>array(
										array('type'=>'click','name'=>'DBA职业规划','key'=>'1'),
										array('type'=>'click','name'=>'案例分析','key'=>'2'),
								  )
							),
							array('type'=>'click','name'=>'错误查询','key'=>'3'),//一级菜单
							array("name"=>'关于恩墨',
								  "sub_button"=>array(
										array('type'=>'click','name'=>'专家介绍','key'=>'4'),
										array('type'=>'click','name'=>'联系方式','key'=>'5'),
										array('type'=>'click','name'=>'恩墨学院','key'=>'6'),

								  )
							)
						)			
				);
					$res = $weObj->createMenu($newmenu);//res为1则创建成功 
